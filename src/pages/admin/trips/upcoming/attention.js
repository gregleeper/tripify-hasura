      ...
      const filteredTrips = tripsData.trips.filter(trip => {
        return (
          trip.numberPrimaryVehiclesReq + trip.numberSupportVehiclesReq !==
            trip.tripVehiclesByTripId_aggregate.aggregate.count ||
          trip.tripVehiclesByTripId_aggregate.aggregate.count !==
            trip.tripDriversByTripId_aggregate.aggregate.count
        );
      });
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ cell: { value }, row: { original } }) => (
          <Link
            href="/admin/trips/manage-trip/[id]"
            as={`/admin/trips/manage-trip/${original.id}`}
          >
            <a>
        ...
        <div className="col-start-3 col-span-10">
          <div className="grid grid-cols-12 mt-3">
            <div className="col-start-6 col-span-2">
              <h3 className="text-2xl text-center">Trips Needing Attention</h3>
            </div>
          </div>
          <div className="grid grid-cols-12">
            <div className="col-start-1 col-span-12 mx-2">
              {trips.length > 0 ? (
                ...
                <div className="text-center">
                  All upcoming trips have the correct number of Vehicles and
                  Drivers assigned.
                </div>
              )}
            </div>
